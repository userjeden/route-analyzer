...
public class InputParsingServiceCsvTest {
    ...
    void shouldThrowExceptionOnWrongIntegrityValue(){
        ...
        Exception exception = assertThrows(InputDataException.class, () -> {
            ...
            inputParsingServiceCsv.parseInput("src/test/resources/DEBRV_DEHAM_historical_routes-wrong_integrity.csv");
        });
    ...
    void shouldThrowExceptionOnAdditionalComma(){
        ...
        Exception exception = assertThrows(InputDataException.class, () -> {
            InputDataServiceCsv inputParsingServiceCsv = new InputDataServiceCsv();
            inputParsingServiceCsv.parseInput("src/test/resources/DEBRV_DEHAM_historical_routes-addiional_comma.csv");
        });
    ...
    void shouldThrowExceptionOnWrongValue(){
        ...
        Exception exception = assertThrows(InputDataException.class, () -> {
            InputDataServiceCsv inputParsingServiceCsv = new InputDataServiceCsv();
            inputParsingServiceCsv.parseInput("src/test/resources/DEBRV_DEHAM_historical_routes-wrong_value.csv");
        });
